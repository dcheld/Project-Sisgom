...
public class OrdemDeServico {
    ...
    /**
     * the Funcionarios setter.
     * @param p_Funcionarios the Funcionarios to set.
     */
    public void setFuncionarios(List<Funcionario> p_funcionarios) {
        this.funcionarios = p_funcionarios;
    }
    /**
     * the fornecedor getter.
    ...
    /**
     * the fornecedor setter.
     * @param p_fornecedor the fornecedor to set.
     */
    public void setFornecedor(Fornecedor p_fornecedor) {
